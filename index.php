...
<body>
    <div class="container">
        ...
        <form action="confirm.php" method="post" class="form">
            ...
            <div class="form-group">
                <label for="jusho1">お住まいの都道府県:</label>
            ...
            <div class="form-group">
                <label for="jusho2">市区町村:</label>
                <input type="text" id="jusho2" name="jusho2" required>
            </div>
            <div class="form-group">
                <label for="jusho3">ご出身の都道府県:</label>
            ...
            <div class="form-group">
            <h2>< 地域編 ></h2>
                <label for="kanshin1">現在のお住まいの地域についての興味・関心について教えてください。</label>
            ...
            <div class="form-group">
                <label for="kanshin2">出身地への興味・関心について教えてください。:</label>
            ...
            <div class="form-group">
                <label for="kanshin3">（当市・当区・当町・当村）への興味・関心について教えてください。:</label>
            ...
            <h2>< 食べ物編 ></h2>
            <div class="form-group">
                <label>地域の食べ物について興味のあるものにチェックしてください。（複数選択可）</label>
            ...
            <h2>< 旅行・観光編 ></h2>
            <div class="form-group">
                <label>旅行・観光について興味のあるものにチェックしてください。（複数選択可）</label>
                <div class="checkbox-group">
            ...
            <h2>< 趣味・娯楽編 ></h2>
            <div class="form-group">
                <label>趣味・娯楽について興味のあるものにチェックしてください。（複数選択可）</label>
                <div class="checkbox-group">
            ...
            <h2>< 地域活動編 ></h2>
            <div class="form-group">
                <label>地域での活動について興味のあるものにチェックしてください。（複数選択可）</label>
                <div class="checkbox-group">
